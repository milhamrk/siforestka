                    ...
                    echo "<div class='col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 '>
                      <form action='".base_url()."produk/keranjang' method='POST'>
                        ...
                        <div class='ps-section__cart-actions'>
                            <a class='ps-btn ps-btn--outline' href='".base_url()."produk'><i class='icon-arrow-left'></i> Kembali Belanja</a>
                            <button type='submit' name='update' style='padding:10px 25px' class='ps-btn'>Lanjut ke Pembayaran <i class='icon-arrow-right'></i></button>
                        </div>
                    </form>";
                    ?>
                    </div>
