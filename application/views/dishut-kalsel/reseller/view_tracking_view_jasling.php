        ...
        <div class="ps-section__content">
            <div class="table-responsive">
                ...
                if ($cek_cod->num_rows()>=1){ // Cek Transaksi COD
                    echo "<p style='font-size:17px'> <div class='alert alert-danger'><strong>PENTING</strong> - Khusus Pesanan Tiket, diharapkan untuk memperlihatkan hasil cetakan</div></p>";
                }
                ...
                if ($cek_onl->num_rows()>=1){ // Cek Transaksi Online
                    ...
                    if ($rows['proses']=='0'){
                        if ($cek_pembayaran->num_rows()>='1'){
                            ...
                            Dan kami telah menginformasikan kepada penjual untuk segera diproses dalam 1 x 24 Jam.</center></div>";
                        }else{
                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                    <div class="ps-block--shopping-total">
                        ...
                        <div class="ps-block__content">
                            <ul class="ps-block__product">
                                <?php
                                  ...
                                  foreach ($penjual->result_array() as $pen) {
                                    ...
                                    if ($pen['kode_kurir']!='0'){
                                        if ($pen['kode_kurir']!='1'){  
                                            echo "<a class='blink_me' href='".base_url()."members/keranjang_detail_jasling/$pen[id_penjualan]'><u>CETAK TIKET</u></a>";
                                        }else{
                                            echo "<a class='blink_me' href='".base_url()."members/keranjang_detail_jasling/$pen[id_penjualan]'><u>CETAK TIKET</u></a>";
                                        }
                                    }else{
                            ...
                            <h3>Total <span><b class='nominaltrx2'><?php echo rupiah($unik['nominal']); ?></b> <button style='float:right; margin-left:10px; border:1px solid #ababab' type='button' id='copy' data-toggle='button' aria-pressed='true'  class='btn btn-default myButtonL' "><span style='font-size:18px' class='fa fa-check'></span></button></span></h3>
                        </div>
                    </div>
                </div>
                </div>
