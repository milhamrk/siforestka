                                ...
                                <?php
                                  ...
                                  foreach ($penjual->result_array() as $pen) {
                                    ...
                                    echo "<li><a href='".base_url()."u/".user_reseller($pen['id_reseller'])."'><u><b>$pen[nama_reseller]</b></u></a> <br>
                                              <b>Ongkir</b> : Rp ".rupiah($pen['ongkir'])." <small style='color:blue'>($total[total_berat] Gram)</small><br>";
                                              ...
                                              echo "<br><b>Dikirim dari</b> : $pen[alamat_lengkap], ".kecamatan($pen['kecamatan_id'],$pen['kota_id'])."</li>";
                                  }
                                ?>
