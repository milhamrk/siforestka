            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                    <?php
                      ...
                      echo "<a href='".base_url()."members/edit_sosial_media' class='ps-btn btn-block'><i class='icon-pen'></i> Edit Sosial Media</a>";
                    ...
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Facebook</b></label>
                              <div class='col-sm-10'>
                              ".($ex[0] == '' ? '-' : "<a target='_BLANK' href='$ex[0]'>$ex[0]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Twitter</b></label>
                              <div class='col-sm-10'>
                              ".($ex[1] == '' ? '-' : "<a target='_BLANK' href='$ex[1]'>$ex[1]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Instagram</b></label>
                              <div class='col-sm-10'>
                              ".($ex[2] == '' ? '-' : "<a target='_BLANK' href='$ex[2]'>$ex[2]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Whatsapp</b></label>
                              <div class='col-sm-10'>
                              ".($ex[3] == '' ? '-' : "<a target='_BLANK' href='https://api.whatsapp.com/send?phone=$ex[3]&text=$row[nama_lengkap]'>$ex[3]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Telegram</b></label>
                              <div class='col-sm-10'>
                              ".($ex[4] == '' ? '-' : "<a target='_BLANK' href='https://telegram.org/$ex[4]'>$ex[4]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Youtube</b></label>
                              <div class='col-sm-10'>
                              ".($ex[5] == '' ? '-' : "<a target='_BLANK' href='$ex[5]'>$ex[5]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>LinkedIn</b></label>
                              <div class='col-sm-10'>
                              ".($ex[6] == '' ? '-' : "<a target='_BLANK' href='$ex[6]'>$ex[6]</a>")."
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Google+</b></label>
                              <div class='col-sm-10'>
                              ".($ex[7] == '' ? '-' : "<a target='_BLANK' href='$ex[7]'>$ex[7]</a>")."
                              </div>
                            </div>";
                        ?>
                    </figure>
