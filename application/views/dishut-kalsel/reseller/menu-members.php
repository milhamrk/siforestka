<ul class="ps-section__links d-none d-sm-block">
    <?php 
        ...
        $data = array('<i class="icon-user"></i> Profile','<i class="icon-couch"></i> Sosmed','<i class="icon-bag-dollar"></i> Data Bank','<i class="icon-bag-dollar"></i> Keuangan','<i class="icon-heart"></i> Wishlist','<i class="icon-bag2"></i> Pembelian','<i class="icon-car"></i> Jadi Kurir '.$pesanan_sopir.'');
