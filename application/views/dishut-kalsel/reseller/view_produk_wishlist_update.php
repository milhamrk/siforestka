<?php if ($record->num_rows()<=0){
    echo "<div class='alert alert-info'><strong>INFORMASI!</strong> - Halo kak, Belum memiliki produk Wishlist? <br> Yuk Lihat-lihat dulu produk yang mungkin dibutuhkan <a href='".base_url()."produk' style='color:#000'><b>disini</b></a>.</div>
    ...
    echo "<div class='col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6 '>
            <div class='ps-product'>
                ...
                <ul class='ps-product__actions produk-$row[id_produk]'>
                    ...
                    <li><a href='".base_url()."members/delete_wishlist/$row[id_konsumen_simpan]' data-toggle='tooltip' data-placement='top' title='Hapus dari Whishlist'><i style='color:red' class='icon-cross'></i></a></li></ul>
                </div>
