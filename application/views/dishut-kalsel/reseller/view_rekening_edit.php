            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12 ">
                    <?php
                      ...
                      echo form_open_multipart('members/edit_rekening_bank',$attributes); 
                    ...
                    <figure class="ps-block--vendor-status biodata">
                        <?php 
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Nama Bank</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='a' class='form-control form-mini' value='$ex[0]'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>No Rekening</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='b' class='form-control form-mini' value='$ex[1]'>
                              </div>
                            </div>
                            ...
                            <label class='col-sm-2 col-form-label' style='margin-bottom:1px'>Atas Nama</b></label>
                              <div class='col-sm-10'>
                              <input type='text' name='c' class='form-control form-mini' value='$ex[2]'>
                              </div>
                            </div>
