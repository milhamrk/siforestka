...
<div class="ps-breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url()."donasi/jemput_zakat"; ?>">Zakat</a></li>
    ...
    <div class="container">
        <div class="ps-section__header">
            <?php
              ...
              echo "<p>Layanan jemput donasi Zakat Maal, Profesi, dan Fitrah bagi perorangan maupun perusahaan.</p>";
            ?>
          </div>
        <div class="ps-section__content">
            <?php 
              $attributes = array('class'=>'ps-form--order-tracking');
              echo form_open_multipart('donasi/jemput_zakat',$attributes); 

              echo "<div class='form-group'><label>Jenis Zakat *</label> <select class='form-control form-auth' name='jenis' required>";
                            $data = array('Zakat Maal','Zakat Profesi','Zakat Fitrah');    
                    ...
                    echo "</select></div>
                    <div class='form-group'><label>Alamat Penjemputan *</label>         <input type='text' name='alamat' class='form-control form-auth' value='' required></div>
            ...
            ?>
                    <div class="form-group">
                        <button type='submit' name='submit' class="ps-btn ps-btn--fullwidth">Jemput Zakat Sekarang</button>
                    </div>
            </form>
        </div>
    </div>
