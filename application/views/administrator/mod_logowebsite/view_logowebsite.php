                ...
                <div class="box-body">
                  ...
                  <?php 
                    ...
                    echo "<input type='hidden' name='id' value='$row[id_logo]'>
                          <tr><td width=120px>Logo Terpasang</td><td><img width='100%' src='".base_url()."asset/logo/$row[gambar]'></td></tr>";
                      $no++;
                    }
                    echo "<tr><td>Ganti Logo</td><td><input type='file' name='logo' class='form-control'></td></tr>
