                ...
                <div class='box-body'>
                  ...
                  <?php
                    ...
                    echo "<table class='table table-striped table-condensed'>
                      <tr><td width='190px'>Nama Lapak / Penjual</td>                <td> : <b>$res[nama_reseller]</b></td></tr>
                    ...
                    if ($reseller->num_rows()<=0){
                      echo "<tr><td colspan='4'><center style='color:red; padding:40px'><i>Anda Belum Memiliki Lapak / Penjual Referral!,.. ^_^</i></center></td></tr>";
                    }else{
