    ...
    echo "<div class='col-md-12'>
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>No Rekening</th>                 <td><input type='text' class='form-control' name='b' value='$rows[no_rekening]'></td></tr>
                    <tr><th scope='row'>Atas Nama</th>                   <td><input type='text' class='form-control' name='c' value='$rows[pemilik_rekening]'></td></tr>
                    <tr><th width='120px' scope='row'>Gambar</th>    <td><input type='file' class='form-control' name='gambar'>";
                                                                        if ($rows['gambar'] != ''){ echo "Lihat Gambar : <a target='_BLANK' href='".base_url()."asset/images/$rows[gambar]'>$rows[gambar]</a>"; } echo "</td></tr>
                  </tbody>
                  </table>
                </div>
              </div>
