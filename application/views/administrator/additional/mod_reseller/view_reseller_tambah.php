    ...
    echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Tambah Data Pelapak</h3>
                </div>
              <div class='box-body'>";
          ...
          echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Nama Pelapak</th>                <td><input class='form-control' type='text' name='c'></td></tr>
                    ...
                    <input class='form-control' type='hidden' name='j' value=''>
