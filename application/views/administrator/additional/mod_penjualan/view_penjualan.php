                  ...
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td><center>
                                ...
                                if ($row['proses']=='0'){
                                  echo "<a style='margin:0px 3px' class='btn btn-primary btn-xs' title='$status Data' href='".base_url()."administrator/proses_penjualan/$row[id_penjualan]/4' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Proses dan stok Penjual (Pembeli) akan otomatis bertambah sesuai dengan orderannya ini?')\"><span class='glyphicon glyphicon-$icon'></span></a>";
                                }elseif ($row['proses']=='1'){
                                  ...
                                  echo "<a style='margin:0px 3px' class='btn btn-primary btn-xs' title='$status Data' href='".base_url()."administrator/proses_penjualan/$row[id_penjualan]/1' onclick=\"return confirm('Apa anda yakin untuk ubah status jadi Proses dan stok Penjual (Pembeli) akan otomatis bertambah sesuai dengan orderannya ini?')\"><span class='glyphicon glyphicon-$icon'></span></a>";
                                }else{
                                  echo "<a style='margin:0px 3px' class='btn btn-default btn-xs' title='Sudah Diproses' href='#' onclick=\"return alert('Maaf, Orderan ini sudah diproses.')\"><span class='glyphicon glyphicon-star'></span></a>";
                                }
