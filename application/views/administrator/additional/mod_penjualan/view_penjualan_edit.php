            <div class="col-xs-12">  
              <div class="box">
                ...
                <?php 
                  ...
                  echo form_open_multipart('administrator/edit_penjualan',$attributes); 
                ?>
                    ...
                    <?php 
                        echo "<tr>
                                ...
                                <td><button type='submit' name='submit' class='btn btn-success  btn-xs'><span class='glyphicon glyphicon-ok' aria-hidden='true'></span></button>
                                    <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/edit_penjualan/".$this->uri->segment(3)."'><span class='glyphicon glyphicon-remove'></span></a>
                                </td>
                              </tr>";
                      ?>
                    <tbody>
                  <?php 
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>
                                <a class='btn btn-warning btn-xs' title='Edit Data' href='".base_url()."administrator/edit_penjualan/".$this->uri->segment(3)."/$row[id_penjualan_detail]'><span class='glyphicon glyphicon-edit'></span></a>
                                <a class='btn btn-danger btn-xs' title='Delete Data' href='".base_url()."administrator/delete_penjualan_detail/".$this->uri->segment(3)."/$row[id_penjualan_detail]' onclick=\"return confirm('Apa anda yakin untuk hapus Data ini?')\"><span class='glyphicon glyphicon-remove'></span></a>
                              </td>
                          </tr>";
                      $no++;
                    }
